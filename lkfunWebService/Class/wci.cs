...
namespace lkfunWebService.Controllers
{
    public class Wci
    {
        ...
        public double Getwci() {
            double O = 0.15 * Math.Log(this.RpD + 1) + 0.85 * Math.Log(10 * ZpD + 1);
            double A = 0.15 * Math.Log(this.RpN + 1) + 0.85 * Math.Log(10 * ZpN + 1);
            double H = 0.15 * Math.Log(this.RtpD + 1) + 0.85 * Math.Log(10 * ZtpD + 1);
            double P = 0.15 * Math.Log(this.Rmax + 1) + 0.85 * Math.Log(10 * Zmax + 1);
